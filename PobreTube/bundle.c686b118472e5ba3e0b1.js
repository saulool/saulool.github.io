...
module.exports = !__webpack_require__(47) && !__webpack_require__(80)(function(){
...
var _VideoSuggestionsList = __webpack_require__(282);

var _VideoSuggestionsList2 = _interopRequireDefault(_VideoSuggestionsList);

var _videoDescription = __webpack_require__(288);
...
var App = function (_Component) {
	...
	(0, _createClass3.default)(App, [{
		key: 'search',
		value: function () {
			var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(searchText) {
				var responseSearch, responseDescription, videos;
					...
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								_context.prev = 0;
								_context.next = 3;
								return _axios2.default.get('https://www.googleapis.com/youtube/v3/search?part=snippet&q=' + searchText + '&type=video&key=AIzaSyB-gXE21gQCGUHHvQL5G9ZoTy_CUfsffMw&maxResults=10');

							case 3:
								responseSearch = _context.sent;
								_context.next = 6;
								return _axios2.default.get('https://www.googleapis.com/youtube/v3/videos?part=snippet&id=' + responseSearch.data.items[0].id.videoId + '&key=AIzaSyB-gXE21gQCGUHHvQL5G9ZoTy_CUfsffMw');

							case 6:
								responseDescription = _context.sent;
								videos = responseSearch.data.items.filter(function (video, index) {
									return index > 0;
								});


								this.setState({ videos: videos, videoID: responseSearch.data.items[0].id.videoId, videoDescription: responseDescription.data.items[0].snippet.description, videoTitle: responseDescription.data.items[0].snippet.title, videoAuthor: responseDescription.data.items[0].snippet.channelTitle, error: false });
								_context.next = 14;
								break;
		...
		key: 'loadVideo',
		value: function () {
			var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(videoID) {
				var responseDescription, responseSearch;
					...
					while (1) {
						switch (_context2.prev = _context2.next) {
							case 0:
								_context2.prev = 0;
								_context2.next = 3;
								return _axios2.default.get("https://www.googleapis.com/youtube/v3/videos?part=snippet&id=" + videoID + "&key=AIzaSyB-gXE21gQCGUHHvQL5G9ZoTy_CUfsffMw");

							case 3:
								responseDescription = _context2.sent;
								_context2.next = 6;
								return _axios2.default.get("https://www.googleapis.com/youtube/v3/search?part=snippet&relatedToVideoId=" + videoID + "&type=video&key=AIzaSyB-gXE21gQCGUHHvQL5G9ZoTy_CUfsffMw&maxResults=10");

							case 6:
								responseSearch = _context2.sent;


								this.setState({ videoID: videoID, videos: responseSearch.data.items, videoDescription: responseDescription.data.items[0].snippet.description, videoTitle: responseDescription.data.items[0].snippet.title, videoAuthor: responseDescription.data.items[0].snippet.channelTitle, error: false });
								_context2.next = 13;
								break;
				...
				return _regenerator2.default.wrap(function _callee3$(_context3) {
					while (1) {
						switch (_context3.prev = _context3.next) {
							case 0:
								_context3.next = 2;
								return this.loadVideo(this.state.videoID);
		...
		value: function render() {
			if (this.state.error) {
				return _react2.default.createElement(
					'div',
					{ className: 'app' },
					_react2.default.createElement(_header2.default, { search: this.search.bind(this) }),
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							{ className: 'col-md-7' },
							_react2.default.createElement(_player2.default, { video: this.state.videoID }),
							_react2.default.createElement(_videoDescription2.default, { title: this.state.videoTitle, author: this.state.videoAuthor, description: this.state.videoDescription })
						),
						_react2.default.createElement(
							'div',
							{ className: 'col-md-5' },
							_react2.default.createElement(_VideoSuggestionsList2.default, { suggestions: this.state.videos, loadVideo: this.loadVideo.bind(this) })
						)
					),
					_react2.default.createElement(_footer2.default, null)
				);
...
var VideoSuggestion = function (_Component) {
	(0, _inherits3.default)(VideoSuggestion, _Component);

	function VideoSuggestion(props) {
		(0, _classCallCheck3.default)(this, VideoSuggestion);
		return (0, _possibleConstructorReturn3.default)(this, (VideoSuggestion.__proto__ || (0, _getPrototypeOf2.default)(VideoSuggestion)).call(this, props));
	}

	(0, _createClass3.default)(VideoSuggestion, [{
		key: "loadVideo",
		...
		value: function render() {
			...
			return _react2.default.createElement(
				"li",
				{ className: "suggestion", onClick: function onClick(event) {
						return _this2.loadVideo(_this2.props.video.id.videoId);
					} },
				_react2.default.createElement("img", { className: "video-thumbnail", src: this.props.video.snippet.thumbnails.default.url }),
				_react2.default.createElement(
					"div",
...
exports.default = VideoSuggestion;
...
var _VideoSuggestion = __webpack_require__(281);

var _VideoSuggestion2 = _interopRequireDefault(_VideoSuggestion);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var VideoSuggestionsList = function VideoSuggestionsList(props) {
	var suggestions = props.suggestions.map(function (suggestion, index) {
		return _react2.default.createElement(_VideoSuggestion2.default, { key: index, video: suggestion, loadVideo: props.loadVideo });
	});
...
exports.default = VideoSuggestionsList;
...
var Header = function Header(props) {
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(_search2.default, { search: props.search })
		)
	);
};
...
var initiateYT = function initiateYT() {
...
var Player = function (_Component) {
	...
	function Player(props) {
		...
		return (0, _possibleConstructorReturn3.default)(this, (Player.__proto__ || (0, _getPrototypeOf2.default)(Player)).call(this, props));
	}
	...
	(0, _createClass3.default)(Player, [{
		...
		value: function render() {
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement('iframe', { id: 'player', className: 'player', width: '100%', height: '360', src: 'https://www.youtube.com/embed/' + this.props.video + '?enablejsapi=1', frameBorder: '0' })
			);
		}
	}]);
	return Player;
...
var Search = function (_Component) {
	...
	(0, _createClass3.default)(Search, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'form',
				{ className: 'form-inline search-form col-md-9', onSubmit: this.onSubmit.bind(this) },
				_react2.default.createElement('input', { className: 'form-control input-lg search-field', placeholder: 'Search', onChange: function onChange(event) {
						return _this2.onChange(event.target.value);
					} }),
				_react2.default.createElement(
					'button',
					{ type: 'submit', className: 'btn btn-lg btn-danger search-button' },
					'Search'
				)
			);
		}
...
var _promise = __webpack_require__(292);
...
__webpack_require__(55)(IteratorPrototype, __webpack_require__(18)('iterator'), function(){ return this; });
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function(test, buggy, set){
      try {
        set = __webpack_require__(79)(Function.call, __webpack_require__(190).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
$export($export.S + $export.F * !(USE_NATIVE && __webpack_require__(316)(function(iter){
